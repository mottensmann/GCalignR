#' Transform large \code{data.frame} containing multiple chromatograms to a list of individual chromatograms
#'
#' Transforms a Matrix containing GC data (retention times, peak area, peak hight etc) in adjacent
#' columns.
#'
#' @param all_gc_mat \code{matrix} or \code{data.frame} containing GC data (retention times, peak area, peak hight etc) for all individuals
...
#'
#' @return
#' \item{chromatograms}{List of data.frames. Each list element contains the GC data for one individual}
#'

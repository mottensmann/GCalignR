# GCalignR 1.0.2.9
___
* Added fill = T as a parameter in utils::read.table to load the GC data within internal functions. *Loading GC data with utils::read.table failed in cases of missing values in a column (i.e. empty). This is the correct behaviour as missing data should always be coded explicitly by 'NA'. Note, the most likely reason of missing data seems to be a mistake in preparing the input file using copy & paste indexing wrong column indices.*

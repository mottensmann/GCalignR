...
#'
#' @description Creates chromatograms with user defined peaks for illustrative purposes
#'
#' @param peaks vector of mean retention times representing peaks in a chromatogram
#'
#' @param N a integer giving the number of chromatograms
#'
#' @param min a numeric giving the minimum retention time
#'
#' @param max a numeric giving the maximum retention time
#'
#' @param Names a character vector giving sample names. By default names are generated by the function
#'
#' @param sd a numeric vector of the same length as peaks giving the standard deviation of peaks. Only supported if N = 1. Default is NULL
#'

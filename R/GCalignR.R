...
#' to analyse patterns across different chromatograms. GCalignR provides functions
#' to align chromatography peaks across samples and simple means of evaluating the

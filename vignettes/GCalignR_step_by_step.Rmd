...
author: "Meinolf Ottensmann, Martin A. Stoffel, Hazel Nichols, Joseph Hoffman"
date: "`r Sys.Date()`"
...
on retention times. The aligned data can easily be used as input
...
* `align_chromatograms`: 
Aligns gas-chromatography peak data by retention times. 
* `gc_heatmap`: 
Plots the results (and intermediate steps) of the alignment. With a heatmap, the user can visually

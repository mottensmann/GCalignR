...
The latest release v1.0.6 is on [CRAN](https://cran.r-project.org/web/packages/GCalignR/index.html). [Click here](https://github.com/mottensmann/GCalignR/releases) for an overview of past releases and a brief description of applied changes.
